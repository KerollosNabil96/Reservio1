          ...
          <div class="p-8">
            ...
            <form @submit.prevent="handleNext" class="space-y-6">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="venueName" placeholder="Enter your venue name" required
              ...
              <div>
                <div class="form-group">
                  ...
                  <div class="flex items-center gap-2">
                    <input type="text" v-model="venueAddress" placeholder="Enter your venue street address"
                      class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-700/80 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 backdrop-blur-sm" />
              ...
              <div class="form-group">
                ...
                <input type="tel" v-model="phoneNumber" @input="validatePhoneNumber"
                  placeholder="Phone number for bookings" required :class="[
              ...
              <div class="form-group">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Government ID</label>
                <CloudinaryUploader v-model="govID" :cloud-name="cloudName" :upload-preset="uploadPreset"
                  folder="government_ids" upload-text="Upload your government ID" @upload-success="handleGovIdUpload" />
              </div>
              ...
              <div class="form-group">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Venue Images (3
                  required)</label>
                <div class="space-y-3">
                  <CloudinaryUploader v-model="firstImage" :cloud-name="cloudName" :upload-preset="uploadPreset"
                    folder="venue_images" upload-text="Upload first venue image"
                  ...
                  <CloudinaryUploader v-model="secondImage" :cloud-name="cloudName" :upload-preset="uploadPreset"
                    folder="venue_images" upload-text="Upload second venue image"
                  ...
                  <CloudinaryUploader v-model="thirdImage" :cloud-name="cloudName" :upload-preset="uploadPreset"
                    folder="venue_images" upload-text="Upload third venue image"
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="shortDescription" placeholder="Brief description (shown in cards)" required
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-700/80 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 backdrop-blur-sm" />
              </div>

              <div class="form-group">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Full Description</label>
                <textarea v-model="description" placeholder="Detailed description of your venue..." required rows="4"
