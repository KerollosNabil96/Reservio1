    ...
    <div class="max-w-2xl mx-auto relative z-10">
      <div
        ...
        <div class="mt-6 flex justify-start">
          <button @click="goBack"
            class="cursor-pointer px-6 py-3 text-sm sm:text-base border-2 border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 transform hover:scale-105 transition-all duration-300 rounded-lg font-medium flex items-center">
