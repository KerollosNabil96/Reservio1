<template>
  <div class="About dark:bg-gray-900 bg-gray-0 overflow-x-hidden">
    ...
    <!-- Who We Are Section -->
    <div
      class="who bg-white py-16 dark:bg-gray-800 transition-all duration-300"
    >
      <div class="container mx-auto px-4">
        <h2
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div class="relative animate-slideRight">
            <div class="rounded-lg overflow-hidden">
              <img
                src="/src/assets/pictures/about-image.jpg"
                alt="About Reservio"
    ...
    <div
      class="Meet py-16 bg-gray-50 dark:bg-gray-800 transition-all duration-300"
    >
      <div class="container mx-auto px-4">
        <h2
          class="font-bold text-3xl md:text-4xl text-center text-blue-600 mb-12 animate-fadeIn"
    ...
    <!-- Our Vision Section -->
    <div
      class="vision bg-gray-50 py-16 dark:bg-gray-800 transition-all duration-300"
    >
      <div class="container mx-auto px-4">
        <h2
          class="font-bold text-3xl md:text-4xl text-center text-blue-600 mb-12 animate-fadeIn"
    ...
    <!-- Our Mission Section -->
    <div
      class="mission bg-white py-16 dark:bg-gray-800 transition-all duration-300"
    >
      <div class="container mx-auto px-4">
        <h2
          class="font-bold text-3xl md:text-4xl text-center text-blue-600 mb-12 animate-fadeIn"
