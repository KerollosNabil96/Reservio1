    ...
    >
      <div class="header-section mb-1">
        <h2 class="mt-5 text-2xl md:text-3xl font-bold dark:text-white">
          {{ $t("dashboardView.greeting", { username: username }) }}
        </h2>
        ...
        <div class="search-section mb-6 flex flex-col sm:flex-row gap-2">
          <div class="search-box w-full sm:w-11/12">
            <input
              type="search"
              v-model="searchQuery"
              :placeholder="$t('dashboardView.searchPlaceholder')"
            ...
            >
              ...
              <div class="relative w-full h-48 mb-4 overflow-hidden rounded-lg">
                <img
                  ...
                  :alt="$t('dashboardView.bookingImageAlt')"
                ...
                >
                  <i
                    class="fas fa-image text-4xl"
                    :title="$t('dashboardView.imagePlaceholderIcon')"
                  ></i>
                </div>
              </div>
