<template>
  <div class="mb-6">
    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Upload your Stadium License</label>
    <CloudinaryUploader v-model="sportOrganizationLicense" :cloud-name="cloudName" :upload-preset="uploadPreset"
      folder="sports_licenses" upload-text="Upload your stadium license" @upload-success="handleLicenseUpload" />
  </div>
