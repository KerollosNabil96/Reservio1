  ...
  <div class="col-span-1 md:col-span-7 animate-fade-in-up animation-delay-500">
    <div
      ...
      <div
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 opacity-70" fill="none" viewBox="0 0 24 24"
          stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <div v-for="(slot, index) in filteredTimeSlots" :key="index" :class="[
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400">
              <span v-if="slot.available > 0">{{ slot.available }} spots available</span>
