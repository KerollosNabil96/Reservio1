    ...
    <div
      ...
      <div class="md:w-1/2 h-48 md:h-auto relative">
        <div class="absolute inset-0 bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
          ...
          <img src="../../assets/pictures/signup.png" alt="Map"
      ...
      <div class="w-full md:w-1/2 p-6 md:p-8 overflow-y-auto" ref="formSection">
        ...
        <form @submit.prevent="register">
          ...
          <div v-if="errorMessage"
            class="mb-4 p-3 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-md" ref="errorMessage">
            {{ errorMessage }}
          </div>
          <!-- Name -->
          <div class="mb-4">
